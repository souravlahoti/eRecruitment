<%@ Page Title="" Language="C#" MasterPageFile="~/HR.Master" AutoEventWireup="true" CodeBehind="ScheduleTestAndInterview.aspx.cs" Inherits="LAYERS.UI.WebForm10" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <fieldset>
            <legend> <h2>Schedule Test and Interview Date</h2></legend>
        <br />      
        <asp:Table runat="server" ID="table" BackColor="MintCream">
        <asp:TableRow>
        <asp:TableCell>
        ...
        <asp:Button ID="Button1" runat="server"  OnClick="Button1_Click"  style="margin-left: 430px" Text="Submit" Width="85px" Height="22px" ValidationGroup="i" />
               ...
               <asp:TableCell>
        <asp:Label ID="Label7" runat="server" Text="Submitted Successfully" ForeColor="#3333ff" Font-Size="X-Large"></asp:Label>
                  </asp:TableCell>
          </asp:TableRow> 
