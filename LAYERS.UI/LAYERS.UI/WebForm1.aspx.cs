...
namespace LAYERS.UI
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        private void FillDropDownList()
        {
            ...
            List<ICandidateTestSchedule> list = test.Display();
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            if (error == 0)
            {
                ...
                ICandidateTestSchedule editObj = CandidateTestScheduleFactory.createCandidateTestSchedule(vacancyId, writtenTestDate, technicalTestDate, hrTestDate);
                ICandidateTestScheduleManager test = CandidateTestScheduleManagerFactory.createScheduleManager();
                bool editStatus = test.editTest(editObj,vacancyId);
                if (editStatus == true)
                    Response.Redirect("DisplayScheduleforHR.aspx");
                else
