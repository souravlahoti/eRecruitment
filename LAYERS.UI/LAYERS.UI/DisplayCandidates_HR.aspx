<%@ Page Title="" Language="C#" MasterPageFile="~/HR.Master" AutoEventWireup="true" CodeBehind="DisplayCandidates_HR.aspx.cs" Inherits="LAYERS.UI.WebForm9" %>
...
<ItemStyle Width="200px"></ItemStyle>
                ...
                <asp:TemplateField HeaderText="Test Status" ItemStyle-Width="200" >
                    <ItemTemplate>
                   <asp:Label id="Label10" runat="server" text='<%#Enum.GetName(typeof(LAYERS.UI.WebForm9.Category),Convert.ToInt32(Eval("scheduleobj.TestScheduleId")))%>'/>
                    </ItemTemplate>
